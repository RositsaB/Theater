...
const allEventsTemplate = (articles) => html`
<section class="welcomePage">
    ...
    <div id="events">
        ...
        <div class="theaters-container">
            ${articles.length == 0 ? html`<h4 class="no-event">No Events Yet...</h4>`
...
<div class="eventsInfo">
    ...
    <div class="info">
        ...
        <div class="info-buttons">
            <a class="btn-details" href="/details/${article._id}">Details</a>
        </div>
    </div>
</div>
`;

export async function allEventsView(ctx) {
    const articles = await getAllEvents();
    ctx.render(allEventsTemplate(articles));
}